...
BUNDLE_ID="com.github.salopensource.sal-scripts"
BUNDLE_PKG="./sal-scripts.pkg"
...
while sleep 10 && date; do
echo "Waiting on Apple too approve the notarization so it can be stapled. This can take a few minutes or more. Script auto checks every 10 sec"
